...
// ReflectionType::__toString() deprecated
echo "\nReflectionType::__toString() *****************\n";
function refTest() : ArrayObject 
{
    return new ArrayObject([1,2,3]); 
}
$reflect = new ReflectionFunction('refTest');
// old approach (deprecated) uses __toString()
echo 'Return Type: ' . $reflect->getReturnType() . "\n";
// new approach (recommended) uses ReflectionNamedType
